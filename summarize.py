        ...
        try:
            response = openai.ChatCompletion.create(
                ...
                {"role": "user", "content": (
                    ...
                    "2. **Principais Benefícios:** Resuma os benefícios que o produto oferece com base nos revisores.\n"
                    "3. **Pontos de Crítica:** Apresente as críticas mais comuns ou relevantes ao produto.\n"
                    "4. **Casos de Uso Recomendados:** Indique para quais tipos de usuários ou contextos o produto é mais adequado.\n"
                    "5. **Veredito Final:** Conclua da mais detalhada possivel recomendando ou não a compra do produto com base nas opiniões predominantes dos revisores.\n\n"
                    f"Transcrição do vídeo:\n{text}"
                )}
            ],
                max_tokens=400,  # Ajuste conforme a necessidade
                temperature=1.0,
            )
